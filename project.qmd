...
Unfortunately, I was not able to complete this project due to being sick for a week and a half
...
```{r}
# I will choosing the question: "How has the share of renewable energy changed from 2021-2023 across states?"

# These are the necessary libraries for this project
library(tidyverse)
library(readr)
